        ...
        <div class="w-full">
            <div class="bg-white shadow-md rounded-lg p-6">
                <div class="flex justify-between items-center border-b pb-4">
                    <h4 class="text-lg font-semibold">Edit Category</h4>
                </div>

                <div class="mt-4">
                    <form action="{{ route('categories.update', $category->description) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <!-- begin: Input Data -->
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div class="flex flex-col">
                                ...
                                <input type="text" id="description" name="description" value="{{ old('description', $category->description) }}" required readonly 
